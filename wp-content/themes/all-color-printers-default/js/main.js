...
(function($) {
  ...
  $( ".m-subnav-arrow.dropdown-toggle" ).each(function( index ) {
    ...
    //$(this).attr('id', 'menu-item-dropdown-'+subId);

  });

  /*$( ".m-subnav-arrow.dropdown-toggle" ).on('click', function() {
    if (!$(this).next('.dropdown-menu').hasClass('show')) {
      $(this).next('.dropdown-menu').removeClass('active').removeClass('show').parent().removeClass('active');
    }
    $(this).parent().parent('.dropdown-menu').addClass('active').parent().addClass('active');
  });*/

  // mobile 3rd level js
  $('.main-menu .navbar-nav > li.menu-item-has-children > .m-subnav-arrow.dropdown-toggle' ).on('click', function() {
    $(this).toggleClass('active1');
    $(this).parent('.menu-item-has-children').toggleClass('active1').toggleClass('show');
    $(this).parent('.menu-item-has-children').children('ul').toggleClass('active1').toggleClass('show');
    /*if (!$(this).parent('li.menu-item-has-children').hasClass('active1') && !$(this).parent('li.menu-item-has-children').hasClass('show')) {
      $(this).parent('li.menu-item-has-children').children('ul').hide().removeClass('active1').removeClass('show').children('ul').hide().removeClass('active1').removeClass('show');
    }*/
  });

  $('.main-menu .navbar-nav > li > ul > li.menu-item-has-children > .m-subnav-arrow.dropdown-toggle' ).on('click', function() {
    $(this).toggleClass('active1');
    $(this).parent('.menu-item-has-children').toggleClass('active').toggleClass('show');
    $(this).parent('.menu-item-has-children').children('ul').toggleClass('active').toggleClass('show');
  });
...
//Magnific Popup
  ...
  $('.lightbox-infographic').magnificPopup({
   type: 'image',
   removalDelay: 500, //Delaying the removal in order to fit in the animation of the popup
   mainClass: 'mfp-fade', //The actual animation
   autoFocusLast:false,
  ...
  $('.smooth-scroll, .smooth-scroll > a').click(function() {
    if (location.pathname.replace(/^\//,'') == this.pathname.replace(/^\//,'') && location.hostname == this.hostname) {
      ...
      var smoothtop = pillar_nav_height ? (header_height + pillar_nav_height) : header_height;
      if (target.length) {
        $('html, body').animate({
...
$(document).ready(function () {
    $('.gall-listing .gall-item:lt(4)').show();
    $('.less').hide();
    var items = $('.gall-listing .gall-item').length;
    var shown =  4;
    $('.more').click(function () {
        $('.less').show();
        shown = $('.gall-listing .gall-item:visible').length+17;
        if(shown< items) {
          $('.gall-listing .gall-item:lt('+shown+')').show(300);
        } else {
          $('.gall-listing .gall-item:lt('+items+')').show(300);
          $('.more').hide();
        }
    });
    $('.less').click(function () {
        $('.gall-listing .gall-item').not(':lt(4)').hide(300);
        $('.more').show();
        $('.less').hide();
    });
});
...
$('.navbar-toggler').on('click', function() {
  $('.site-nav-container-screen').toggleClass('active');
});
});
