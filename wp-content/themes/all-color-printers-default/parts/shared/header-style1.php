		...
		<div class="container">
            ...
            <?php
				...
				<div class="col-8 text-right">
					<span class="sh-search "><a href="#search" class="search-form-tigger" data-toggle="search-form" aria-label="Search"><span class="material-icons">search</span><span>Search</span></a></span>
			        <?php
			...
			<div class="container">
				...
				<?php endif; ?>
						...
						<div class="utility-nav navbar-right">
					        ...
					        $unformatted_tel_number = preg_replace("/[^0-9]/", '', $tel_number);?>
					        <?php if ($tel_number): ?>
					              <span class="sh-ph d-lg-none m-0"><a class="cms_phone" href="tel:<?php echo $unformatted_tel_number;?>" aria-label="Phone Number" title="<?php echo $unformatted_tel_number;?>"><span class="material-icons">call</span> <span><?php echo $tel_number;?></span></a></span>
					        <?php endif ?>

					        <?php
					        $email_address = get_field('global_email', 'option');
					        if ($email_address): ?>
					            <span class="sh-email d-lg-none m-0"><a class="cms_email" href="mailto:<?php echo strtolower($email_address); ?>" title="Email Us" aria-label="Email Us"><span class="material-icons">mail_outline</span> <span><?php echo $email_address; ?></span></a></span>
					        <?php endif ?>
					        	<span class="sh-search d-lg-none m-0 "><a href="#search" class="search-form-tigger" data-toggle="search-form" aria-label="Search"><span class="material-icons">search</span></a></span>
							...
							<?php endif; ?>
							<a class="button btn btn-primary d-none d-lg-inline-block m-0 cont-btn"  href="/contact-us/" target="<?php echo esc_attr( $link_target ); ?>">Contact Us</a>
							    <a class="button btn btn-primary d-lg-none px-4 m-0" href="/contact-us/" target="<?php echo esc_attr( $link_target ); ?>">Contact</a>
						</div>
