		...
		<nav class="navbar navbar-expand-lg navbar-light">
			<div class="container">
				...
				<div class="collapse navbar-collapse" id="navbarNavDropdown">
					...
					<span class="sh-search mx-3"><a href="#search" class="search-form-tigger" aria-label="Search"  data-toggle="search-form"><i class="fa fa-search" aria-hidden="true"></i></a></span>
				</div>
				...
				<div class="utility-nav navbar-right d-lg-none">
					...
					<span class="sh-search mx-3"><a href="#search" class="search-form-tigger"  data-toggle="search-form"><i class="fa fa-search" aria-hidden="true" aria-label="Search"></i></a></span>
					<?php 
					$link = get_field('request_quote_link', 'option');
					if( $link ): 
					    $link_url = $link['url'];
